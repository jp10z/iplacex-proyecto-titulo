...
Insert into proyecto (NOMBRE,DESCRIPCION,ID_ESTADO) values ('Producción','Contiene servidores de producción','1');
Insert into proyecto (NOMBRE,DESCRIPCION,ID_ESTADO) values ('Desarrollo','Destinado a servidores de desarrollo','1');
Insert into proyecto (NOMBRE,DESCRIPCION,ID_ESTADO) values ('QA','Contiene servidores de QA y testing','1');

Insert into servidor (NOMBRE,DESCRIPCION,ID_PROYECTO,ID_ESTADO) values ('Producción IIS 1','Servicio primario de producción que contiene las webs y apis','1','1');
Insert into servidor (NOMBRE,DESCRIPCION,ID_PROYECTO,ID_ESTADO) values ('Producción IIS 2','Servidor secundario de producción que contiene las webs y apis','1','1');
Insert into servidor (NOMBRE,DESCRIPCION,ID_PROYECTO,ID_ESTADO) values ('Producción IIS backup','Servidor de backup de producción que contiene webs y apis','1','1');
